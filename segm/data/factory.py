...
from segm.data import DIS5KDataset
from segm.data import MedicalDataset
...
def create_dataset(dataset_kwargs):
    ...
    db_name = dataset_kwargs.pop("db_name")
    ...
    elif dataset_name == "dis5k":
        dataset = DIS5KDataset(db_name=db_name, split=split, **dataset_kwargs)
    elif dataset_name == "medical":
        #print("*****")
        dataset = MedicalDataset(db_name=db_name, split=split, **dataset_kwargs)
    else:
