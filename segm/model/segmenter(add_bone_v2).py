...
class Segmenter(nn.Module):
    def __init__(
        ...
        self.add_cor_encoder = add_cor_encoder_query ### zjw added 8.22.10.27
        self.add_cor_encoder_ep = add_seg_encoder_ep
    ...
    def forward(self, gim, lim, gim_gt, lim_gt, random_mask): #gim:query, lim:example
        ...
        ep_x_cor = self.add_cor_encoder_ep(ep_x)
